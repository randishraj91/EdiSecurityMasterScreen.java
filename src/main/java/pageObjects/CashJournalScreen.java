...
public class CashJournalScreen {
    By systemMaster = By.xpath("//*[@id='simple-menu']/ul/li[4]/em");
    By navigateCash = By.xpath("//a[text()='Cash Journal Entry']");
    ...
    By amount = By.xpath("//input[@class]//following::input[6]");
    ...
    By currency = By.xpath("//input[@class]//following::input[14]");
    By source = By.xpath("//input[@class]//following::input[15]");
    By batchno = By.xpath("//input[@class]//following::input[16]");
    By tradedate = By.xpath("//input[@class]//following::input[17]");
    ...
    By textTooVerify = By.xpath("//*[contains(text(),'Cash Journal has been created successfully!')]");
    ...
    //    BaseLibrary.SetWaitTime(1000);
        BaseLibrary.waitAndClickElement(navigateCash);
    }
    ...
    public void amount(String text) throws Exception {
        BaseLibrary.setFocusToElement(amount);
        BaseLibrary.clearText(amount);
        BaseLibrary.sendKeysToWebElement(amount, text);
        //   BaseLibrary.SetWaitTime(100);
    ...
    public void CashSave() throws Exception {
        ;
    ...
    public void verifyValidationMessage(String sVerify) throws Exception {
        ...
        BaseLibrary.verifyText(By.xpath("//*[contains(text(),'Cash Journal has been created successfully!')]"), sVerify);
    ...
    public void EditCashJournal(String textToSent) throws Exception {

        BaseLibrary.waitAndClickElementsUsingByLocator(EditTrade);
        BaseLibrary.clickOnTextFromDropdownList(editdetails,textToSent);
    }
    public void CancelCashJournal(String textToSent) throws Exception {
